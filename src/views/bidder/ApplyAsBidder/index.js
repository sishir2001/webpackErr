...
// const ApplyAsBidder = (props) => {
//   return <div>ApplyAsBidder</div>
// }

// export default ApplyAsBidder
  ...
  return (
    <CRow>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>Application</strong> <small>Form</small>
          </CCardHeader>
          <CCardBody>
            {/*<p className="text-medium-emphasis small">
            ...
            <p className="text-medium-emphasis small">
              Add Personal Details, this will subject to validation and wrong input results penalty.
            </p>
            <DocsExample href="forms/layout#gutters">
              <CForm className="row g-3">
                ...
                <CCol xs={12}>
                  <CButton type="submit">Submit For Approval</CButton>
                </CCol>
              </CForm>
            </DocsExample>
          </CCardBody>
